    ...
    if mode == 1:
        ...
        case = int(
            input(
                ...
                "Введите команду: "))
    if case == 1:
        with open('params/alph.txt', 'r', encoding="utf-8") as lang_file:
        ...
        open('params/random_first_text.txt', 'w', encoding="utf-8").write(y)
        open('params/random_second_text.txt', 'w', encoding="utf-8").write(z)
        ...
        with open('params/alph_eng.txt', 'r', encoding="utf-8") as lang_file:
            lang = lang_file.read().rstrip().lower()

        with open('params/eng_text_1.txt', 'r', encoding="utf-8") as lang_file:
            y = lang_file.read().rstrip().lower()

        with open('params/eng_text_2.txt', 'r', encoding="utf-8") as lang_file:
            z = lang_file.read().rstrip().lower()

        open('params/first_text.txt', 'w', encoding="utf-8").write(y)
        open('params/second_text.txt', 'w', encoding="utf-8").write(z)
        print('Последовательности сгенерированы\n')
        return y, z, lang

    elif case == 3:
        with open('params/alph_rus.txt', 'r', encoding="utf-8") as lang_file:
            lang = lang_file.read().rstrip().lower()

        with open('params/rus_text_1.txt', 'r', encoding="utf-8") as lang_file:
            y = lang_file.read().rstrip().lower()

        with open('params/rus_text_2.txt', 'r', encoding="utf-8") as lang_file:
            z = lang_file.read().rstrip().lower()
        ...
        for num in range(1, 5):
            ...
            with open(f'params/rus_text_1_{num}.txt', 'r', encoding="utf-8") as lang_file:
                rus_text_1 = lang_file.read().rstrip().lower()

            with open(f'params/rus_text_2_{num}.txt', 'r', encoding="utf-8") as lang_file:
                rus_text_2 = lang_file.read().rstrip().lower()

            with open(f'params/eng_text_1_{num}.txt', 'r', encoding="utf-8") as lang_file:
                eng_text_1 = lang_file.read().rstrip().lower()

            with open(f'params/eng_text_2_{num}.txt', 'r', encoding="utf-8") as lang_file:
...
def crypt(key, text):
    with open('params/alphv.txt', 'r', encoding="utf-8") as lang_file:
        alph = lang_file.read().rstrip().lower()
...
def vigenere_encrypt():
    with open('params/key.txt', 'r', encoding="utf-8") as key_file:
        key = key_file.read().rstrip().lower()

    text = open('params/text.txt', 'r', encoding="utf-8").read().lower()

    en_text = crypt(key, text)

    if en_text:
        open('params/encrypted_text.txt', 'w', encoding="utf-8").write(en_text)
...
def vigenere_decrypt():
    ...
    encrypted_text = open('params/encrypted_text.txt', 'r', encoding="utf-8").read().lower()
    ...
    for c in encrypted_text:
        ...
        j += 1
    open('params/decrypted_text.txt', 'w', encoding="utf-8").write(decrypted_text)
...
def shift():
    ...
    for l in range(1, 16):
        with open('params/encrypted_text.txt', 'r', encoding="utf-8") as en_text_file:
