...
def main():
    ...
    if opt == '0':
        m, n = int(input('Введите число m\n')), int(input('Введите число n\n'))
        print('Цепная дробь =', chain(m, n))
    ...
    if opt == '4':
        a, n = int(input('Введите число а\n')), int(input('Введите число p\n'))
        print('Символ Лежандра = ', legendre(a, n))
        print('Символ Якоби = ', jacobi(a, n))

    if opt == '5':
        a, p = int(input('Введите число a\n')), int(input('Введите число p\n'))
        print('Квадратичный корень для этого числа а =', sqrt(a, p))
